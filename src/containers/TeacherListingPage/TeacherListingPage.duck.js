...
export const SET_INITIAL_VALUES = 'app/TeacherListingPage/SET_INITIAL_VALUES';

export const SHOW_LISTING_REQUEST = 'app/TeacherListingPage/SHOW_LISTING_REQUEST';
export const SHOW_LISTING_ERROR = 'app/TeacherListingPage/SHOW_LISTING_ERROR';

export const FETCH_REVIEWS_REQUEST = 'app/TeacherListingPage/FETCH_REVIEWS_REQUEST';
export const FETCH_REVIEWS_SUCCESS = 'app/TeacherListingPage/FETCH_REVIEWS_SUCCESS';
export const FETCH_REVIEWS_ERROR = 'app/TeacherListingPage/FETCH_REVIEWS_ERROR';

export const FETCH_TIME_SLOTS_REQUEST = 'app/TeacherListingPage/FETCH_TIME_SLOTS_REQUEST';
export const FETCH_TIME_SLOTS_SUCCESS = 'app/TeacherListingPage/FETCH_TIME_SLOTS_SUCCESS';
export const FETCH_TIME_SLOTS_ERROR = 'app/TeacherListingPage/FETCH_TIME_SLOTS_ERROR';

export const FETCH_LINE_ITEMS_REQUEST = 'app/TeacherListingPage/FETCH_LINE_ITEMS_REQUEST';
export const FETCH_LINE_ITEMS_SUCCESS = 'app/TeacherListingPage/FETCH_LINE_ITEMS_SUCCESS';
export const FETCH_LINE_ITEMS_ERROR = 'app/TeacherListingPage/FETCH_LINE_ITEMS_ERROR';

export const SEND_ENQUIRY_REQUEST = 'app/TeacherListingPage/SEND_ENQUIRY_REQUEST';
...
const TeacherListingPageReducer = (state = initialState, action = {}) => {
...
export default TeacherListingPageReducer;
