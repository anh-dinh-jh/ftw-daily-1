...
import { sendEnquiry, fetchTransactionLineItems, setInitialValues } from './TeacherListingPage.duck';
import SectionImages from './SectionImages';
import SectionAvatar from './SectionAvatar';
import SectionHeading from './SectionHeading';
import SectionGeneralMaybe from './SectionGeneralMaybe';
...
export class TeacherListingPageComponent extends Component {
  ...
  onContactUser() {
    ...
    if (!currentUser) {
      ...
      // that modal does open when user is redirected back to this TeacherListingPage
      callSetInitialValues(setInitialValues, { enquiryModalOpenForListingId: params.id });

      // signup and return back to TeacherListingPage.
  ...
  render() {
    ...
    const bookingTitle = (
      <FormattedMessage id="TeacherListingPage.bookingTitle" values={{ title: richTitle }} />
    );
    const bookingSubTitle = intl.formatMessage({ id: 'TeacherListingPage.bookingSubTitle' });
    ...
    if (showListingError && showListingError.status === 404) {
      ...
      const errorTitle = intl.formatMessage({
        id: 'TeacherListingPage.errorLoadingListingTitle',
      });
          ...
          <LayoutSingleColumn className={css.pageRoot}>
            ...
            <LayoutWrapperMain>
              <p className={css.errorText}>
                <FormattedMessage id="TeacherListingPage.errorLoadingListingMessage" />
              </p>
            </LayoutWrapperMain>
            <LayoutWrapperFooter>
              <Footer />
      ...
      const loadingTitle = intl.formatMessage({
        id: 'TeacherListingPage.loadingListingTitle',
      });
          ...
          <LayoutSingleColumn className={css.pageRoot}>
            ...
            <LayoutWrapperMain>
              <p className={css.loadingText}>
                <FormattedMessage id="TeacherListingPage.loadingListingMessage" />
              </p>
            </LayoutWrapperMain>
            <LayoutWrapperFooter>
              <Footer />
    ...
    const schemaTitle = intl.formatMessage(
      { id: 'TeacherListingPage.schemaTitle' },
