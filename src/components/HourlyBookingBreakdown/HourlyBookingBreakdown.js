...
export const HourlyBookingBreakdownComponent = props => {
  const {
    rootClassName,
    className,
    userRole,
  ...
  /**
   * HourlyBookingBreakdown contains different line items:
   *
...
HourlyBookingBreakdownComponent.defaultProps = { rootClassName: null, className: null, dateType: null };

HourlyBookingBreakdownComponent.propTypes = {
...
const HourlyBookingBreakdown = injectIntl(HourlyBookingBreakdownComponent);

HourlyBookingBreakdown.displayName = 'HourlyBookingBreakdown';

export default HourlyBookingBreakdown;
