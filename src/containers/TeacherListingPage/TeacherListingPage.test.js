...
import { showListingRequest, showListingError, showListing } from './TeacherListingPage.duck';

import { TeacherListingPageComponent } from './TeacherListingPage';
...
describe('TeacherListingPage', () => {
  it('matches snapshot', () => {
    ...
    const tree = renderShallow(<TeacherListingPageComponent {...props} />);
  ...
  describe('ActionBarMaybe', () => {
    it('shows users own listing status', () => {
      ...
      expect(formattedMessages.at(0).props().id).toEqual('TeacherListingPage.ownListing');
      expect(formattedMessages.at(1).props().id).toEqual('TeacherListingPage.editListing');
    });
    it('shows users own pending listing status', () => {
      ...
      const formattedMessages = actionBar.find(FormattedMessage);
      expect(formattedMessages.length).toEqual(2);
      expect(formattedMessages.at(0).props().id).toEqual('TeacherListingPage.ownListingPendingApproval');
      expect(formattedMessages.at(1).props().id).toEqual('TeacherListingPage.editListing');
    });
    it('shows users own closed listing status', () => {
      ...
      const formattedMessages = actionBar.find(FormattedMessage);
      expect(formattedMessages.length).toEqual(2);
      expect(formattedMessages.at(0).props().id).toEqual('TeacherListingPage.ownClosedListing');
      expect(formattedMessages.at(1).props().id).toEqual('TeacherListingPage.editListing');
    });
    it('shows closed listing status', () => {
      ...
      expect(formattedMessages.at(0).props().id).toEqual('TeacherListingPage.closedListing');
    });
