...
import EditTeacherListingAvailabilityForm from './EditTeacherListingAvailabilityForm';

export const Empty = {
  component: EditTeacherListingAvailabilityForm,
  props: {
    onSubmit: values => {
      console.log('Submit EditTeacherListingAvailabilityForm with (unformatted) values:', values);
    },
