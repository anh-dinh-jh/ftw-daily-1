  ...
  switch (tab) {
    case GENERAL: {
      const submitButtonTranslationKey = isNewListingFlow
        ? 'EditTeacherListingWizard.saveNewDescription'
        : 'EditTeacherListingWizard.saveEditDescription';
      return (
        <EditTeacherListingGeneralPanel
          {...panelProps(GENERAL)}
    ...
    case LOCATION: {
      const submitButtonTranslationKey = isNewListingFlow
        ? 'EditTeacherListingWizard.saveNewLocation'
        : 'EditTeacherListingWizard.saveEditLocation';
      return (
        <EditTeacherListingLocationPanel
          {...panelProps(LOCATION)}
          submitButtonText={intl.formatMessage({ id: submitButtonTranslationKey })}
    ...
    case PRICING: {
      const submitButtonTranslationKey = isNewListingFlow
        ? 'EditTeacherListingWizard.saveNewPricing'
        : 'EditTeacherListingWizard.saveEditPricing';
      return (
        <EditTeacherListingPricingPanel
          {...panelProps(PRICING)}
          submitButtonText={intl.formatMessage({ id: submitButtonTranslationKey })}
    ...
    case AVAILABILITY: {
      const submitButtonTranslationKey = isNewListingFlow
        ? 'EditTeacherListingWizard.saveNewAvailability'
        : 'EditTeacherListingWizard.saveEditAvailability';
      return (
        <EditTeacherListingAvailabilityPanel
    ...
    case PHOTOS: {
      const submitButtonTranslationKey = isNewListingFlow
        ? 'EditTeacherListingWizard.saveNewPhotos'
        : 'EditTeacherListingWizard.saveEditPhotos';
