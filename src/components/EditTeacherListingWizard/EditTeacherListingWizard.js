...
const RedirectToStripe = ({ redirectFn }) => {
  ...
  return <FormattedMessage id="EditTeacherListingWizard.redirectingToStripe" />;
};

// Create a new or edit listing through EditTeacherListingWizard
class EditTeacherListingWizard extends Component {
  ...
  handlePayoutSubmit(values) {
    this.props
      ...
      .then(response => {
        this.props.onManageDisableScrolling('EditTeacherListingWizard.payoutModal', false);
      })
      .catch(() => {
        // do nothing
      });
  ...
  render() {
    ...
    return (
      <div className={classes}>
        ...
        <Modal
          id="EditTeacherListingWizard.payoutModal"
        ...
        >
          <div className={css.modalPayoutDetailsWrapper}>
            <h1 className={css.modalTitle}>
              <FormattedMessage id="EditTeacherListingWizard.payoutModalTitleOneMoreThing" />
              <br />
              <FormattedMessage id="EditTeacherListingWizard.payoutModalTitlePayoutPreferences" />
            </h1>
            {!currentUserLoaded ? (
              ...
              <>
                <p className={css.modalMessage}>
                  <FormattedMessage id="EditTeacherListingWizard.payoutModalInfo" />
                </p>
