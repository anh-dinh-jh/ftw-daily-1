...
import {
  ...
  clearUpdatedTab,
  savePayoutDetails,
} from './EditTeacherListingPage.duck';

import css from './EditTeacherListingPage.module.css';
...
export const EditTeacherListingPageComponent = props => {
  ...
  if (shouldRedirect) {
    ...
    // Images are passed to EditTeacherListingForm so that it can generate thumbnails out of them
    ...
    const loadingPageMsg = {
      id: 'EditTeacherListingPage.loadingListingData',
    };
    return (
...
const mapStateToProps = state => {
  const page = state.EditTeacherListingPage;
  const {
    getAccountLinkInProgress,
    getAccountLinkError,
