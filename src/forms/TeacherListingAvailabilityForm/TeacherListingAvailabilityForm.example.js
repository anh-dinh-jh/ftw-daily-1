...
import TeacherListingAvailabilityForm from './TeacherListingAvailabilityForm';

export const Empty = {
  component: TeacherListingAvailabilityForm,
  props: {
    onSubmit: values => {
      console.log('Submit TeacherListingAvailabilityForm with (unformatted) values:', values);
    },
